...
- The CNN reference is slightly higher overall; GraphMS v3.5.1 Hybrid is retained as the final selected graph-aware hybrid research system and is not described as a universal numerical winner.
